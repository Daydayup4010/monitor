...
func InitGorm() {
	...
	err = db.AutoMigrate(&models.SkinItem{}, &models.UItem{}, &models.BuffItem{}, &models.GoodsInfo{}, &models.UItemsInfo{}, &models.BuffInventory{}, &models.Inventory{}) // migrate schema
	if err != nil {
