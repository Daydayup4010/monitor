...
func InitGorm() {
	...
	err = db.AutoMigrate(&models.U{}, &models.BaseGoods{}, &models.User{}, &models.Settings{}, &models.APIKey{}, &models.Buff{}, &models.C5{}, &models.Steam{}, &models.UBaseInfo{}, &models.PriceHistory{}, &models.PaymentOrder{}, &models.SystemConfig{}) // migrate schema
	if err != nil {
